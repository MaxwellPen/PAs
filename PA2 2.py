...
def simulation():
    ...
    possibleLinesLess10 = [line1,line2,line3,line4,express]
    possibleLinesGreater10 = [line1,line2,line3,line4]
    ...
    for time in range(7200):
        ...
        if time%50 == 0: #prints of the data every 50 secs
            ...
            print('    4.' + express.printCustomerList())
            print('\n')
...
def main():#runs the simulation and creates the table 
    ...
    for i in range(12):#runs simulation 12 times 
        ...
        line1totItems, line1totCustomers, line1IdleTime, line1WaitTime, line2totItems, line2totCustomers, line2IdleTime, line2WaitTime, line3totItems, line3totCustomers, line3IdleTime, line3WaitTime, line4totItems, line4totCustomers, line4IdleTime,line4WaitTime, expresstotItems, expresstotCustomers, expressIdleTime,expressWaitTime = simulation()    
...
"""
    totCust = line1Customers + line2Customers + line3Customers + line4Customers + expressCustomers

    totItem = line1Items + line2Items + line3Items + line4Items + expressItems

    totidle = line1Idle + line2Idle + line3Idle + line4Idle  + expressIdle

    totwait = line1Wait + line2Wait + line3Wait + line4Wait + expressWait
    ...
    print(f'{5:^10} {expressCustomers:^12} {expressItems :^15}   {expressIdle/60:^17.2f} {expressWait:^30}')   
    """
